...
APP_ID = int(os.environ.get("APP_ID", "20180361"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb://jkb73212:Pj8Lqlut0CUi5M5j@<hostname>/?ssl=true&replicaSet=atlas-pgtvpp-shard-0&authSource=admin&retryWrites=true&w=majority&appName=Cluster0")
